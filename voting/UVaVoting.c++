// g++-4.7 -pedantic -std=c++11 -Wall UVaVoting.c++ -o UVaVoting
// UVaVoting < RunVoting.in > RunVoting.out
// g++-4.7 -lm -lcrypt -O2 -std=c++11 -pipe -DONLINE_JUDGE UVaVoting.c++ -o UVaVoting
